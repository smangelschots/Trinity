namespace OfficeSoft.Data.Crud
{
    ...
    public abstract class DataCommandCollection<T> : BindingList<T>
        where T : class
    {
        public SqlServerDataManager<T> DataManager { get; set; }
        ...
        public DataCommandCollection(SqlServerDataManager<T> dataManager)
        {
        ...
        protected override void RemoveItem(int index)
        {
            ...
            var command = this.DataManager.GetCommand(index);
            command.CommandType = DataCommandType.Delete;
            this.DataManager.ExecuteCommand(command);
