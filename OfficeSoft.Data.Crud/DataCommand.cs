...
namespace OfficeSoft.Data.Crud
{
        ...
        where T : class
    {
        ...
        //TODO Implement Validation traking
        protected internal void OnSetValidation(ModelCommandValidationEventArgs<T> e)
        {
            ...
            foreach (var propertyInfo in properties)
            {
                ...
                if (propertyInfo.CanWrite)
                {
                    ...
                    if (!atribute.Any())
                    {
                        ...
                        {
                            var column = columnEntityFrameworkAttribute.FirstOrDefault() as System.ComponentModel.DataAnnotations.Schema.ColumnAttribute;
                            if (column != null)
                            {
                                name = column.Name;
                            }
        ...
        {
            var modelType = typeof(T);
            var tableEntityFrameworkAttribute =
                modelType.GetCustomAttributes(
                    typeof(System.ComponentModel.DataAnnotations.Schema.TableAttribute),
                    false);
            if (tableEntityFrameworkAttribute.Any())
            {
                var table = tableEntityFrameworkAttribute.FirstOrDefault() as System.ComponentModel.DataAnnotations.Schema.TableAttribute;
                if (table != null)
                {
                    return table.Name;
                }
        ...
        internal void AddPropertyChange(PropertyInfo property)
        {
        ...
        private string GetField<TField>(Expression<Func<T, TField>> field)
        {
            if (field == null)
        ...
        //private CommandExpression Convert(MethodCallExpression body)
        //{
    ...
    public abstract class DataCommand
    {
        ...
        internal IDataManager Manager { get; set; }
        ...
        public string TabelName
        {
            ...
            set
            {
                ...
                //    {
                //        _tabelName = string.Format("[{0}]", value);
                //        return;
                //    }
                //}
                _tabelName = value;
