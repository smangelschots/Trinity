...
namespace Trinity.MySql
{
        ...
        where T : class
    {
        ...
        protected override ICommandResult ExecuteDeleteCommand(MySqlModelCommand<T> dataCommand, IDbCommand command)
        {
            ...
            if (string.IsNullOrEmpty(dataCommand.GetWhereText()))
        ...
        protected override Task<ICommandResult> ExecuteDeleteCommandAsync(MySqlModelCommand<T> dataCommand, IDbCommand command)
        {
            throw new NotImplementedException();
        }

        protected override Task<ICommandResult> ExecuteUpdateCommandAsync(MySqlModelCommand<T> dataCommand, IDbCommand command)
        {
            throw new NotImplementedException();
        }

        protected override Task<ICommandResult> ExecuteInsertCommandAsync(MySqlModelCommand<T> dataCommand, IDbCommand command)
        {
            throw new NotImplementedException();
        }

        protected override Task<ICommandResult> ExecuteSelectCommandAsync(MySqlModelCommand<T> dataCommand, IDbCommand command)
        {
            throw new NotImplementedException();
        }
    }
